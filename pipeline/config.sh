...
AI_TEXT_AGENT_MODE="${AI_TEXT_AGENT_MODE:-0}" # 1 = 3-Rollen-Agenten-Prompt aktivieren
AI_TEXT_AGENT_PREFIX="${AI_TEXT_AGENT_PREFIX:-Text:}" # Prefix fuer Agenten-Ausgabe
AI_TEXT_AGENT_DEBUG="${AI_TEXT_AGENT_DEBUG:-0}" # 1 = internen Agenten-Workflow in Datei mitschreiben
AI_TEXT_AGENT_WALLY="${AI_TEXT_AGENT_WALLY:-Planner}" # Rollenname Agent 1
AI_TEXT_AGENT_TRIXI="${AI_TEXT_AGENT_TRIXI:-Optimizer}" # Rollenname Agent 2
AI_TEXT_AGENT_HERBIE="${AI_TEXT_AGENT_HERBIE:-Reviewer}" # Rollenname Agent 3
AI_TEXT_AGENT_STYLE="${AI_TEXT_AGENT_STYLE:-klar, sachlich, praezise}" # Schreibstil fuer Agentenmodus
